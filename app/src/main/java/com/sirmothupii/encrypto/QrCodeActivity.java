...
public class QrCodeActivity extends Activity implements Callback, OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.blikoon.qrcodescanner.R.layout.activity_qr_code);
        initView();
        initData();
    ...
    private void checkPermission() {
        ...
        if (hasHardware) {
            if (!hasCameraPermission()) {
                findViewById(com.blikoon.qrcodescanner.R.id.qr_code_view_background).setVisibility(View.VISIBLE);
    ...
    private void initView() {
        TextView tvPic = (TextView) findViewById(com.blikoon.qrcodescanner.R.id.qr_code_header_black_pic);
        mIvFlashLight = (ImageView) findViewById(com.blikoon.qrcodescanner.R.id.qr_code_iv_flash_light);
        mTvFlashLightText = (TextView) findViewById(com.blikoon.qrcodescanner.R.id.qr_code_tv_flash_light);
        mQrCodeFinderView = (QrCodeFinderView) findViewById(com.blikoon.qrcodescanner.R.id.qr_code_view_finder);
        mSurfaceView = (SurfaceView) findViewById(com.blikoon.qrcodescanner.R.id.qr_code_preview_view);
        mLlFlashLight = findViewById(com.blikoon.qrcodescanner.R.id.qr_code_ll_flash_light);
        mHasSurface = false;
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        findViewById(com.blikoon.qrcodescanner.R.id.qr_code_view_background).setVisibility(View.GONE);
        if (mCaptureActivityHandler == null)
        {
           // mCaptureActivityHandler = new CaptureActivityHandler(this);
        }
    ...
    public void onClick(View v) {
        if(v.getId() == com.blikoon.qrcodescanner.R.id.qr_code_iv_flash_light)
        {
        ...
        }else if(v.getId() == com.blikoon.qrcodescanner.R.id.qr_code_header_black_pic)
        {
            if (!hasCameraPermission()) {
                    mDecodeManager.showPermissionDeniedDialog(this);
                } else {
